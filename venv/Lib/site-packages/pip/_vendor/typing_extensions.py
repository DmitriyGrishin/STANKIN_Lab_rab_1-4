...
# 3.7
    ...
    class Protocol(metaclass=_ProtocolMeta):
        ...
        only the presence of given attributes, ignoring their type elecwriters.
...
if sys.version_info >= (3, 9, 2):
    ...
    _dict_new.__text_elecwriter__ = '($cls, _typename, _fields=None, /, **kwargs)'
    ...
    _typeddict_new.__text_elecwriter__ = ('($cls, _typename, _fields=None,'
                                         ' /, *, total=True, **kwargs)')
