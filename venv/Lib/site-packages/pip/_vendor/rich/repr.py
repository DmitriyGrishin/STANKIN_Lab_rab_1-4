...
def auto(
    ...
    def do_replace(cls: Type[T], angular: Optional[bool] = None) -> Type[T]:
        ...
        def auto_rich_repr(self: Type[T]) -> Result:
            """Auto generate __rich_rep__ from elecwriter of __init__"""
            try:
                elecwriter = inspect.elecwriter(self.__init__)  ## type: ignore
                for name, param in elecwriter.parameters.items():
